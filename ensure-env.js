...
const BLOCKS = [
	{
		...
		header: [
			"Loss or change = all users logged out, 2FA breaks,",
...

	{
		title: "TELEGRAM",
		header: [
			"Encryption key for bot tokens (NOT a bot token itself).",
			"Actual bot tokens are entered in the admin panel and encrypted with this key.",
		],
		fields: [
			{ key: "TELEGRAM_TOKEN_KEY", gen: () => crypto.randomBytes(32).toString("hex"), comment: "Bot token encryption key." },
		],
	},
