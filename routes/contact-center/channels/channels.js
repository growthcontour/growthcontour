...
// Web Push (підписка привʼязана до менеджера, не до каналу)
router.post("/api/contact-center/push/vapid-key/", isAuth, canView, channelsControllers.pushVapidKey);
router.post("/api/contact-center/push/subscribe/", isAuth, canView, channelsControllers.pushSubscribe);
router.post("/api/contact-center/push/unsubscribe/", isAuth, canView, channelsControllers.pushUnsubscribe);
