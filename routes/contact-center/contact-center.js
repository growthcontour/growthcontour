...
router.post("/api/contact-center/managers/search/", authorizationControllers.isAuthenticated, conversationsControllers.managersSearch);
...
router.post("/api/contact-center/chat/:id/typing/", authorizationControllers.isAuthenticated, conversationsControllers.typing);
router.post("/api/contact-center/chat/:id/message/:msgId/edit/", authorizationControllers.isAuthenticated, conversationsControllers.editMessage);
router.post("/api/contact-center/chat/:id/forms/", authorizationControllers.isAuthenticated, conversationsControllers.listForms);
router.post("/api/contact-center/chat/:id/send-form/", authorizationControllers.isAuthenticated, conversationsControllers.sendForm);
router.post("/api/contact-center/chat/:id/create-lead/", authorizationControllers.isAuthenticated, conversationsControllers.createLead);
router.post("/api/contact-center/chat/:id/create-order/", authorizationControllers.isAuthenticated, conversationsControllers.createOrder);
