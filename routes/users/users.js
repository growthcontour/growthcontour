...
router.get("/users/:id/", authorizationControllers.isAuthenticated, async (req, res) => {
	try {
...
router.get("/users/:id/edit", authorizationControllers.isAuthenticated, authorizationControllers.checkPermission("users.list", "view"), async (req, res) => {
	try {
		const id = parseInt(req.params.id);
		const id_lang = req.user.id_lang || 1;
...
router.get("/users/groups/:id/permissions", authorizationControllers.isAuthenticated, authorizationControllers.checkPermission("users.groups", "view"), async (req, res) => {
	try {
		const id = parseInt(req.params.id);
		const id_lang = req.user.id_lang || 1;
...
router.post("/api/users/groups/:id/permissions/toggle", authorizationControllers.isAuthenticated, authorizationControllers.checkPermission("users.groups", "edit"), async (req, res) => {
	try {
...
router.post("/api/users/:id/login-log", authorizationControllers.isAuthenticated, authorizationControllers.checkPermission("users.list", "view"), async (req, res) => {
	try {
		const id = parseInt(req.params.id);
...
router.post("/api/users/:id/update-password", authorizationControllers.isAuthenticated, authorizationControllers.checkPermission("users.list", "edit"), async (req, res) => {
	try {
		const id = parseInt(req.params.id);
...
router.post("/api/users/:id/resend-invite", authorizationControllers.isAuthenticated, authorizationControllers.checkPermission("users.list", "add"), async (req, res) => {
	const conn = await connection_pool.getConnection();
	try {
		const id = parseInt(req.params.id);
